    ...
    <div class="main-panel">
        <div class="content-wrapper">
            <div class="page-header">
                <h3 class="page-title">Gestionar Aviso Público</h3>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="dashboard.php">Tablero</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Gestionar Aviso Público</li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-sm-flex align-items-center mb-4">
                                <h4 class="card-title mb-sm-0">Gestionar Aviso Público</h4>
                                <a href="#" class="text-dark ml-auto mb-3 mb-sm-0">Ver todos los Avisos Públicos</a>
                            </div>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="font-weight-bold">Título del Aviso</th>
                                            <th class="font-weight-bold">Fecha del Aviso</th>
