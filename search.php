  ...
  <div class="main-panel">
    <div class="content-wrapper">
      <div class="page-header">
        <h3 class="page-title"> Buscar Estudiante </h3>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="dashboard.php">Tablero</a></li>
            <li class="breadcrumb-item active" aria-current="page"> Buscar Estudiante</li>
          </ol>
        </nav>
      </div>
      <div class="row">
            ...
            <div class="card-body">
              <form method="post">
                <div class="form-group">
                  ...
                  <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Buscar por ID o Nombre del Estudiante">
                </div>
                ...
                <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th class="font-weight-bold">Clase del Estudiante</th>
                      <th class="font-weight-bold">Nombre del Estudiante</th>
                      <th class="font-weight-bold">Correo del Estudiante</th>
