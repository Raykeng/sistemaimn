    ...
    if (isset($_POST['submit'])) {
        ...
        if ($query->rowCount() == 0) {
            ...
            if (!in_array($extension, $allowed_extensions)) {
                ...
                if ($LastInsertId > 0) {
                    echo '<script>alert("El estudiante ha sido agregado.")</script>';
            ...
            echo "<script>alert('El ID del estudiante ya existe. Por favor, inténtalo de nuevo');</script>";
        }
    }
?>
<!DOCTYPE html>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="forms-sample row" method="post" enctype="multipart/form-data">
                                    ...
                                    <h3 class="col-md-12">Detalles del Padre</h3>
                                    <div class="form-group col-md-6">
