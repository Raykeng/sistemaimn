...
<html lang="en">
  <head>
    ...
    <title>Instituto Mixto Normal</title>
    <!-- plugins:css -->
...
{               ?>
        <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
          <h5 class="mb-0 font-weight-medium d-none d-lg-flex mx-auto"><?php  echo htmlentities($row->AdminName);?> BIENVENIDO AL SISTEMA DE REGISTROS DE LA OFICINA DE LA MUJER, MALACATÁN, SAN MARCOS.</h5>
