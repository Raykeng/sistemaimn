    ...
    <div class="main-panel">
        <div class="content-wrapper">
            <div class="page-header">
                <h3 class="page-title"> Actualizar Estudiantes </h3>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="dashboard.php">Tablero</a></li>
                        <li class="breadcrumb-item active" aria-current="page"> Actualizar Estudiantes</li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title" style="text-align: center;">Actualizar Estudiantes</h4>
                            ...
                            <form class="forms-sample" method="post" enctype="multipart/form-data">
                                ...
                                ?>
                                        <div class="form-group">
                                            <label for="exampleInputName1">Nombre del Estudiante</label>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputName1">Correo Electrónico del Estudiante</label>
                                            <input type="email" name="stuemail" value="<?php echo htmlentities($row->StudentEmail); ?>" class="form-control" required='true'>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail3">Clase del Estudiante</label>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputName1">ID del Estudiante</label>
                                            <input type="text" name="stuid" value="<?php echo htmlentities($row->StuID); ?>" class="form-control" required='true' pattern="[a-zA-Z0-9]+">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName1">Foto del Estudiante</label>
                                            <img src="assets/images/<?php echo $row->Image; ?>" width="100" height="100" value="<?php echo $row->Image; ?>"><a href="changeimage.php?editid=<?php echo $row->ID; ?>"> &nbsp; Editar Imagen</a>
                                        </div>
                                        <h3>Detalles del Padre/Guardián</h3>
                                        <div class="form-group">
