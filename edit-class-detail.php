        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Administrar Grados</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Estadisticas</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Administrar Grados</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Editar Grado</h4>
...
{               ?>  
                      <div class="form-group">
                        <label for="exampleInputName1">Nombre del Grado</label>
